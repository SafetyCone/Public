...
namespace Eshunna
{
    public static class Properties
    {
        ...
        public static readonly string ExampleMeshPoissonPlyFilePathPropertyName = @"Example Mesh Poisson PLY File Path";
        public static readonly string ExampleMeshPoissonSimplePlyFilePathPropertyName = @"Example Mesh Poisson Simple PLY File Path";
