...
namespace Minex.Common.Lib.Visuals
{
    ...
    public class GrayColor
    {
        ...
        {
            bool output = GrayColor.VerifyPixelParameterRange(color, Pixel.DefaultColorParameterRangeMinimum, Pixel.DefaultColorParamtereRangeMaximum, false);
            return output;
        }
        ...
        {
            GrayColor.VerifyPixelParameterRange(color, Pixel.DefaultColorParameterRangeMinimum, Pixel.DefaultColorParamtereRangeMaximum, true);
        }
