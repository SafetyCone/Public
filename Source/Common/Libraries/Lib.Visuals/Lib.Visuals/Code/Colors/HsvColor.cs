...
namespace Minex.Common.Lib.Visuals
{
    ...
    public class HsvColor
    {
        ...
        {
            bool output = HsvColor.VerifyPixelParameterRange(color, Pixel.DefaultColorParameterRangeMinimum, Pixel.DefaultColorParamtereRangeMaximum, false);
            return output;
        }
        ...
        {
            HsvColor.VerifyPixelParameterRange(color, Pixel.DefaultColorParameterRangeMinimum, Pixel.DefaultColorParamtereRangeMaximum, true);
        }
