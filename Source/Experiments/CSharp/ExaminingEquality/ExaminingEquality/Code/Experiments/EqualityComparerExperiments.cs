...
{
    public static class EqualityComparerExperiments
    {
        public static void SubMain()
        {
            //EqualityComparerExperiments.WhatIsTheDefaultEqualityComparerType();
            //EqualityComparerExperiments.IsDefaultDictionaryComparerTheDefaultComparer();
        }

        /// <summary>
        /// Result: True.
        /// There are many claims that <see cref="Dictionary{TKey, TValue}"/> by default uses the <see cref="EqualityComparer{T}.Default"/> comparer for TKey if none is specified in its constructor.
        ...
        /// </summary>
        private static void IsDefaultDictionaryComparerTheDefaultComparer()
        {
        ...
        /// What is the type of <see cref="EqualityComparer{T}.Default"/>? This method provides a specimen instance to examine.
        ...
        /// </summary>
        private static void WhatIsTheDefaultEqualityComparerType()
        {
