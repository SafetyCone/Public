...
namespace PythonFromNet
{
    class Program
    {
        ...
        private static void TryRunNeuralNetwork2()
        {
            MnistData mnistData = BinarySerializer<MnistData>.DeserializeStatic(Program.RawBasedMnistNetDoubleDataFilePath);
            ...
            //TrainingPerformanceData performanceData = network.RunTraining(mnistData.TrainingData, 5, mnistData.TestData);
            TrainingPerformanceData performanceData = network.RunTraining(mnistData.TrainingData, 3, initialNetworkData, miniBatchFilePathManager, mnistData.TestData);
